...
togglebutton.push_handler('on_toggle', toggle_button_handler)
...
pushbutton.push_handler('on_press', push_button_handler)
pushbutton.push_handler('on_release', release_button_handler)
...
slider.push_handler('on_change', slider_handler)
...
text_entry.push_handler('on_commit', text_entry_handler)
